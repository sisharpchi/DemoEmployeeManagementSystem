...
{
    /// <inheritdoc />
    public partial class InitialCreationUpdateEmployeeTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SancitonTypeId = table.Column<int>(type: "int", nullable: true),
                    CivilId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FileNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Other = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sanctions_SanctionTypes_SancitonTypeId",
                        column: x => x.SancitonTypeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sanctions_SancitonTypeId",
                table: "Sanctions",
                column: "SancitonTypeId");
